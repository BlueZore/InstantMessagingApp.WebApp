<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="InstantMessagingApp.AddUser" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_row">
            关键字：<asp:TextBox ID="txtUserName" runat="server"></asp:TextBox>
